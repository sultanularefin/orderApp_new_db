...
//
                                              ...
                                              animatedWidgetShowFullOrderType()
                                                  : /*1 */
                                              animatedWidgetShowSelectedOrderType(oneOrder), /* 2*/
...
//        final String foodImageURL =          filteredItems[index].imageURL;
  ...
  Widget animatedWidgetShowSelectedOrderType(Order unObsecuredInputandPayment) {
    final shoppingCartbloc = BlocProvider.of<ShoppingCartBloc>(context);
...
////                :
            child: ((showEditingCompleteCustomerAddressInformation)
                &&
                (showEditingCompleteCustomerHouseFlatIformation) && (showEditingCompleteCustomerPhoneIformation==false) )
                ?
            Container(
              margin: EdgeInsets.fromLTRB(
                  0, 0, 0, 15),
