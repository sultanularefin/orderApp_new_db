...
//                                            width: displayWidth(context) * 0.57,
              ...
              AnimatedSwitcher(
                duration: Duration(milliseconds: 3000),
//
                child: showFullPaymentType==false ? animatedWidgetShowSelectedPaymentType(unObsecuredInputandPayment):
...
//  Widget animatedWidgetShowSelectedPaymentTypeTakeAway(Order unObsecuredInputandPayment){
  Widget animatedWidgetShowSelectedPaymentType(Order unObsecuredInputandPayment) {
