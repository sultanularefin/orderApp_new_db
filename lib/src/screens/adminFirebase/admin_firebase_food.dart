...
// Screen files.
import 'package:foodgallery/src/screens/adminFirebase/ingredientsForFood.dart';
...
//
                                ...
                                Container(
                                    ...
                                    child:Text("default ingredients",style:TextStyle(
                                      color: Colors.red,
                                    ),
                                    )
                                ),
...
//                                        _itemData.ingredients = val)),
                                ...
                                // DISABLED SIZES STARTS HERE. -->BELOW

                                SizedBox(height: 20),

                                Container(
                                    alignment: Alignment.center,
                                    child:Text("auto genrated prices",style:TextStyle(
                                      color: Colors.red,
                                    ),
                                    )
                                ),
                                ...
                                TextFormField(
                                  decoration:
                                  InputDecoration(
                                      labelText: 'LASTEN || SMALL'),
                                  keyboardType: TextInputType.number,
                                  enabled: false,
//                                    initialValue: _itemData.getPriceInEuro,
                                  initialValue: 'getPriceInEuro',
//                                  toStringAsFixed(2),
                                ...
                                TextFormField(
                                    ...
                                    keyboardType: TextInputType.number,
                                    enabled: false,
                                    initialValue: 'getPriceInEuro *(1.2)'
                                ...
                                TextFormField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  enabled: false,
                                  initialValue: 'getPriceInEuro *(1.5)',
                                ...
                                TextFormField(
                                  decoration:
                                  InputDecoration(
                                      labelText: 'PHERE || FAMILY'),
                                  keyboardType: TextInputType.number,
                                  enabled: false,
                                  initialValue:'getPriceInEuro *(2.5)',
                                ...
                                TextFormField(
                                  decoration:
                                  InputDecoration(
                                      labelText: 'PANNU || BUCKET'),
                                  keyboardType: TextInputType.number,
                                  enabled: false,
                                  initialValue: 'getPriceInEuro *(4)',
                                ...
                                TextFormField(
                                  decoration:
                                  InputDecoration(
                                      labelText: 'GLUTEENITON ||'
                                          'PROTEIN FREE'),
                                  keyboardType: TextInputType.number,
                                  enabled: false,
                                  initialValue: 'getPriceInEuro *(1)',

                                ),


                                // DISABLED SIZES  FINISHES HERE.
                                // -->ABOVE.
...
//                                                });
                                            ...
                                            String firestoreDocument = await _itemData
                                                .save(); // invokes the method in ItemData class.


                                            if (firestoreDocument != "error" ) {
                                              return Navigator.push(context,
                                                  MaterialPageRoute(
                                                      builder: (context) =>
                                                          IngredientsForFood(
