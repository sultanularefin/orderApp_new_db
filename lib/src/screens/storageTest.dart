...
class StorageTest extends StatelessWidget {
  ...
  //  E/flutter (11272): [ERROR:flutter/lib/ui/ui_dart_state.cc(157)] Unhandled Exception:
  //  PlatformException(error, Please use a gs:// URL for your Firebase Storage bucket., null)


  final Widget child;
  //  final FirebaseStorage storage = FirebaseStorage(storageBucket: 'foodItems/');
  final FirebaseStorage storage = FirebaseStorage();
  ...
  StorageTest({Key key, this.child}) : super(key: key);
  MyHomePage createState() => MyHomePage();


//  StorageTest({this.storage});
